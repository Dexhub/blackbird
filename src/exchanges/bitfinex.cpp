...
std::string Gurl="/v1/ticker/ethusd";
const char *orderURL="/v1/book/ethusd";
...
double getActivePos(Parameters& params)
{
  ...
  {
    *params.logFile << "<Bitfinex> WARNING: ETH position not available, return 0.0" << std::endl;
    position = 0.0;
  }
  else
  {
